  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "CinemaForge turns a screenplay, stills, and a cut-out actor into a narrated film. Screen The Last Lighthouse and inspect the cut.",
      },
